			...
			<div id="serverErrors"> <span id="serverSideDanger" class="text-danger"></span> </div>
                <div id="profileForm">
                        ...
                        <div class="row">    
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="description" style="background-color: #faf5f8;"></textarea>
                    ...
                    <div class="well" style="background-color: #faf5f8;">
                    ...
                    <div class="well" style="background-color: #faf5f8;">
                        ...
                        <div id="profilePassword">
                            <div class="row">    
                                ...
                                <div class="checkbox">     
                                    <label><input type="checkbox" id="checkNewPassword" name="newPassword"> Yes</label>
                                </div>
